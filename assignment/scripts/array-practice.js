...
let favoriteFoods = ['yellow curry','buscuits & gravy','pizza']
...
console.log('second animal is bird')
...
console.log('favoriteFoods are now', favoriteFoods)
// 4.d TODO: Remove the food at the beginning of your array &
//     log both the food removed and the updated array
removedFood = favoriteFoods.shift();
console.log('removed first food', removedFood);
console.log('foods are now', favoriteFoods);
